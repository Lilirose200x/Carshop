...
public class Technician extends User implements Serializable
{
  ...
  public Technician(String aUsername, String aPassword, boolean aIsLoggedIn, TechnicianType aType, CarShop aCarShop)
  {
  ...
  private static final long serialVersionUID = -1211464533824871133L ;
