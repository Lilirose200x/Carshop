...
public class CarShop implements Serializable
{
  ...
  public boolean setSystemTime(Time aSystemTime)
  {
  ...
  public boolean setSystemDate(Date aSystemDate)
  {
    boolean wasSet = false;
  ...
  public Customer addCustomer(String aUsername, String aPassword, boolean aIsLoggedIn)
  {
    return new Customer(aUsername, aPassword, aIsLoggedIn, this);
  }
  ...
  public Technician addTechnician(String aUsername, String aPassword, boolean aIsLoggedIn, Technician.TechnicianType aType)
  {
    ...
    {
      return new Technician(aUsername, aPassword, aIsLoggedIn, aType, this);
    }
  }
  ...
  public String toString()
  {
    return super.toString() + "["+ "]" + System.getProperties().getProperty("line.separator") +
            "  " + "systemTime" + "=" + (getSystemTime() != null ? !getSystemTime().equals(this)  ? getSystemTime().toString().replaceAll("  ","    ") : "this" : "null") + System.getProperties().getProperty("line.separator") +
            "  " + "systemDate" + "=" + (getSystemDate() != null ? !getSystemDate().equals(this)  ? getSystemDate().toString().replaceAll("  ","    ") : "this" : "null") + System.getProperties().getProperty("line.separator") +
  ...
  private static final long serialVersionUID = -161978952884434170L ;
